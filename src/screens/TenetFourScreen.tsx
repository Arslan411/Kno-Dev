...
const TenetFourScreen = ({ navigation }: RootStackScreenProps<"TenetFour">) => {
      ...
      >
        ...
        >
          ...
          >
            <View style={{ top: 10 }}>
              <StrokeText
                myText={`I choose my partners, but I act with kindness towards everyone.
              `}
              />
            </View>
          </LinearGradient>
...
export default TenetFourScreen;
